...
# Fit the Stan model
stan_fit = stan('lognorm_uncert.stan', data = stan_data, iter = 2000, chains = 4)
...
write.table(stan_samples, './stan_samples_uncert.txt', row.names=FALSE, col.names=FALSE, fileEncoding = 'UTF-8')


# Fit the Stan model
stan_fit = stan('lognorm_no_uncert.stan', data = stan_data, iter = 2000, chains = 4)
...
write.table(stan_samples, './stan_samples_no_uncert.txt', row.names=FALSE, col.names=FALSE, fileEncoding = 'UTF-8')
