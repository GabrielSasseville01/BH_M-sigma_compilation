...
# Fit the Stan model
stan_fit = stan('final_model.stan', data = stan_data, iter = 2000, chains = 4)
...
write.table(stan_samples, './final_model.txt', row.names=FALSE, col.names=FALSE, fileEncoding = 'UTF-8')